...
func TestFileOpen(t *testing.T) {
	...
	for _, tc := range []TestCase{
		...
		conf, err := xconfig.Custom(&value, loader.NewPlugin(tc.Source, tc.Unmarshall, loader.Config{}, nil))
		if err != nil {
			t.Fatal(err)
		}
...
func TestMulti(t *testing.T) {
	...
	open := loader.NewPlugin("testdata/config_rethink.json", json.Unmarshal, loader.Config{}, nil)
